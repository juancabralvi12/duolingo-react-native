  ...
  return (
    <View className="relative overflow-hidden rounded-2xl bg-primary-purple p-5">
      <View className="max-w-[62%] gap-2">
        <Text className="font-poppins-medium text-body-md text-white/80">Continue training</Text>
        <Text className="font-poppins-bold text-h1 text-white">{trackName}</Text>
