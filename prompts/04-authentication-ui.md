...
- Auth copy should say "singing journey", "practice", or "vocal training" instead of "language journey".
- Do not change the attached layout just to make the singing copy fit.
